...
public class HexFeatureManager : MonoBehaviour {
    ...
    public void AddWall (
        ...
        if (nearCell.Walled != farCell.Walled &&
            ...
            nearCell.GetEdgeType (farCell) != HexMetrics.HexEdgeType.Cliff) {
    ...
    void AddWallSegment (
        ...
        bool hasLeftWall = !leftCell.IsUnderwater &&
            pivotCell.GetEdgeType (leftCell) != HexMetrics.HexEdgeType.Cliff;
        bool hasRightWall = !rightCell.IsUnderwater &&
            pivotCell.GetEdgeType (rightCell) != HexMetrics.HexEdgeType.Cliff;
